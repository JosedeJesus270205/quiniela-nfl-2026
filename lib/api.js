...
function verPartido(partido, contexto) {
  ...
  return {
    ...
    resultado: resultado && resultado.final ? {
      ...
      // Solo se avisa si de verdad se conto el minuto 60 (semana 2 en adelante).
      normal: resultado.prorroga && resultado.tiempoNormal && resultado.cuenta !== 'final'
        ? reglas.marcadorQueCuenta(resultado) : null,
